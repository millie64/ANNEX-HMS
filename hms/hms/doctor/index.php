...
<html lang="en">
	<head>
		<title>AnnexHMS Doctor Login</title>
		<meta charset="utf-8" />
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase">AnnexHMS</span>. <span>All rights reserved</span>
					</div>
